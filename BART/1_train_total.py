...
if __name__ == '__main__':
    ...
    train_dataset = '/data/lihuan/DPR/DPR-main/outputs/translate_BART_1Q3A_train_20230922.json'
    train_model_name = 'model_1Q3A_DPR_20231129_lr2e-4'
    output_name = 'output_1Q3A_DPR_20231129_lr2e-4'
