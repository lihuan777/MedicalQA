...
# Load the JSON file and save the first 3000 entries
    ...
    output_file2 = r'D:\code\MedicalQA\二次检索任务\数据集\8\001_candidate0.txt'
    with open(output_file2, 'w', encoding='utf-8') as outfile2:
        for ans in ans_contents2:
            outfile2.write(str(ans) + '\n')

    # 将ans_contents3保存到txt文件
    output_file3 = r'D:\code\MedicalQA\二次检索任务\数据集\8\002_candidate0.txt'
...
input_file_path = "D:/code/DPR/DPR-main/outputs/results/translate_BART_1Q3A_categories_rear_20231023.json"
output_file_path = "D:/code/MedicalQA/二次检索任务/8 ES类型检索+DPR后置 检索数据.json"
