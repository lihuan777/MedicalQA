...
with open(f"D:/code/lihuan/DPR/DPR-main/downloads/data/retriever/cn_train_dpr_categories.json",'w',encoding='utf-8') as f:
    ...
    with open(f"D:/code/lihuan/MedicalQA/1_translate/cn_train_15W_20230918.json",'r',encoding='utf-8') as trainData:
            ...
            "query": {
                "bool": {
                    "must": [
                        ...
                        {
                            "terms": {"categories.keyword": line['categories'] }
                        }
                    ]
                }
            }
        ...
        if len(results['hits']['hits']) == 30:
            ...
            for j in range(10):
                ...
                if j == 0:
                    ...
                    tempData = results['hits']['hits'][j-1]
                    temp = {
                        "title":tempData['_source']["ques_title"],
                        "text":getAnswers(tempData['_source']['ans_contents']),
