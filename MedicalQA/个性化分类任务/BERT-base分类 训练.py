...
def run_train(dataset,):
    ...
    output_dir = '个性化分类任务/结果/BERT-base'
    ...
    # 加载BERT Tokenizer
    tokenizer = BertTokenizer.from_pretrained('个性化分类任务/模型/models--google-bert--bert-base-cased')
    ...
    # 加载BERT模型
    model = BertForSequenceClassification.from_pretrained('个性化分类任务/模型/models--google-bert--bert-base-cased', num_labels=len(label_encoder.classes_))
    ...
    training_args = TrainingArguments(
        output_dir='./' + dataset + '_BERT-base',          # 输出目录
